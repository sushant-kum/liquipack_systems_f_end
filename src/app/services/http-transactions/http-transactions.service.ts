...
export class HttpTransactionsService {
  ...
  get_login: API = {
    ...
    sendRequest: (username: string, password: string) => {
      const hostname: string = this.get_login.hostname == null ? this.default_hostname : this.get_login.hostname;
      const basepath: string = this.get_login.basepath == null ? this.default_basepath : this.get_login.basepath;
  ...
  get_login_token: API = {
    ...
    path: '/login/token',
    sendRequest: () => {
      const hostname: string = this.get_login_token.hostname == null ? this.default_hostname : this.get_login_token.hostname;
      const basepath: string = this.get_login_token.basepath == null ? this.default_basepath : this.get_login_token.basepath;
  ...
  get_users: API = {
    ...
    path: '/users',
    sendRequest: () => {
      const hostname: string = this.get_users.hostname == null ? this.default_hostname : this.get_users.hostname;
      const basepath: string = this.get_users.basepath == null ? this.default_basepath : this.get_users.basepath;
  ...
  get_users_user_id: API = {
    ...
    sendRequest: (user_id: string) => {
      const hostname: string = this.get_users_user_id.hostname == null ? this.default_hostname : this.get_users_user_id.hostname;
