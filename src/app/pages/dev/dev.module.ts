...
/* Brand Icons */
import { faCss3Alt as fabCss3Alt, faAngular as fasAngular } from '@fortawesome/free-brands-svg-icons';
...
export class DevModule {
  constructor(fa_icon_library: FaIconLibrary) {
    ...
    fa_icon_library.addIcons(fasFont, fasPalette, fasChevronRight);
    // Include regular fa icons
    // Include brand fa icons
    fa_icon_library.addIcons(fabCss3Alt, fasAngular);
  }
}
